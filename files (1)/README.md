...
1. Upload the `modern-admin-ui` folder to `/wp-content/plugins/`
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to **Modern Admin UI** in your admin menu
4. Toggle on "Settings → General"
5. Save settings and visit Settings → General to see it in action!
